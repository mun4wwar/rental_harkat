<x-layouts.auth title="Login Customer" :bg="'bg-green-100'">
    <x-auth.card>
        <x-auth.title class="text-green-600">Login</x-auth.title>

        <form method="POST" action="{{ route('login') }}">
            @csrf
            <input type="hidden" name="login_from" value="customer">
